<template>
  <div>
    ...
    > -->
      <div
        class="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-32 lg:my-32"
      >
        <!--Main Col-->
        <div
          id="profile"
        ...
        >
          <div class="p-4 md:p-12 text-center">
            ...
            <img
              ...
              alt=""
            />
            <h1 class="text-3xl font-bold pt-6">Baihaki Al Biruni</h1>
            <div
            ...
            <p class="p-8 lg:text-lg text-md">
              Web Developer Enthusiast menyukai hal - hal berbau teknologi dan
              juga menyukai dunia investasi.
            </p>
          </div>
        </div>
      </div>
